...
public class CxfWebServiceConfig {
     ...
     */
    @Bean
    public DingWebService h3yunService() {
        return new DingWebServiceImpl();
    }
     ...
     */
    @Bean
    public Endpoint endpoint(DingWebService dingWebService) {
        EndpointImpl endpoint = new EndpointImpl(springBus(), dingWebService);
        endpoint.publish("/service");//发布地址
        return endpoint;
    }
}
