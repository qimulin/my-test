 ...
 * 创建一个Repository的相关接口（可以加注解@RepositoryDefinition），这个接口必须继承Repository接口，
...
public interface BookRepository extends ElasticsearchRepository<Book, String> {
    /**
     * 在Spring Data reppository支持直接按名字解析，但是起的方法名要按照一定的规则来取，解析的时候会剥离以下的套词，
     * 然后对剩下的部分进行解析，查询的套词如下：find…By, read…By, query…By, count…By和get…By，
